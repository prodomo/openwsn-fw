...
#define UPLOAD_PERIOD_TIME_8MS 8000
...
#define ALARM_PC2_ACTIVE_HIGH

#ifdef ALARM_PC2_ACTIVE_HIGH
#define ALARM_PC2_OFF 0
#define ALARM_PC2_ON GPIO_PIN_2
#else
#define ALARM_PC2_OFF GPIO_PIN_2
#define ALARM_PC2_ON 0
#endif
